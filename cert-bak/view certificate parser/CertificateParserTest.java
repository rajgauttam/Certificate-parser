...
public class CertificateParserTest {
    ...
    @Test
    public void identityCertificateTest(){
        List<CertificateNodeEntry>  certificateNodeEntries = CertificateParserHelper.getIdentityCertificateNodeEntry(identityCertificateStr);
          ...
          List<CertificateNodeEntry> certificateNodeChildrenList = certificateNodeEntries.get(0).getChildrenList();
          ...
          List<CertificateNodeEntry> issuedByChildrenList = certificateNodeChildrenList.get(2).getChildrenList();
          ...
          /** Issued From */
          assertEquals(certificateNodeChildrenList.get(3).getKey(), "Issued From");
          assertNull(certificateNodeChildrenList.get(3).getValue());
          List<CertificateNodeEntry> issuedFromChildrenList = certificateNodeChildrenList.get(3).getChildrenList();
    ...
    public void caCertificateTest() {
        List<CertificateNodeEntry>  certificateNodeEntries = CertificateParserHelper.getCaCertificateNodeEntry(caCertificateStr);
        assertNotNull(certificateNodeEntries);
        assertEquals(certificateNodeEntries.size(), 1);
    ...
    private String convertDate(String dateValue, String zone){

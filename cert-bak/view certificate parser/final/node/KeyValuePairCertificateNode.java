 ...
 *
 */
public class KeyValuePairCertificateNode {
	...
	private List<KeyValuePairCertificateNode> children = null;
...
//			addChildAtIndex(child, childrenOrderMap.lastKey()+1);
	...
	public Boolean isLeaf() {
		return this.childrenOrderMap.isEmpty();
	}
			...
			if(node != null){
				if(node.getKey().equals(anotherNode.getKey())){
					if(node.getValue() != null && anotherNode.getValue() != null){
						...
						throw new RuntimeException("Two or more than two diffent types of nodes with "

 ...
 *
 */
public class KeyValuePairCertificateNode extends AbstractCertificateNode<KeyValuePairCertificateNode> {
	...
	@Override
	public Iterator<KeyValuePairCertificateNode> iterator() {
